...
namespace Selenium_Test
{
    class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            capability.AddAdditionalCapability("os", "MAC");
            //capability.AddAdditionalCapability("os_version", "11", true);
            capability.AddAdditionalCapability("browser", "safari");

            driver = new RemoteWebDriver(new Uri("http://192.168.0.104:4444"), capability);
          ...
          //  String s = driver.FindElement(By.XPath("//*[@class='lighter']")).Text;
           // Console.WriteLine(s);
            ...
            driver.Navigate().GoToUrl("http://foo:bar@httpbin.org/basic-auth/foo/bar");
            Thread.Sleep(5000);
            ...
            driver.Navigate().GoToUrl("https://codepen.io/GBora/pen/VLYyzY");
